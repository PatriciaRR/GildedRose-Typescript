...
export class GildedRose {
    ...
    updateQuality() {
        for (let i = 0; i < this.items.length; i++) {
            ...
            // if(this.item[i].name == 'Sulfuras, Hand of Ragnaros') {
                //this.items[i].quality = this.items[i].sellIn 
            //}

            if (this.items[i].quality < 50 && this.items[i].name != 'Backstage passes to a TAFKAL80ETC concert') { // these 2 lines need to go
